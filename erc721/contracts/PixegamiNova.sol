...
contract PixegamiNova is ERC721, ERC721Enumerable, ERC2981, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    mapping(uint256 => string) private _tokenMapping;
    uint256 constant MAX_TOKENS = 8;
    address constant RECEIVER = 0x39da2Ffca6233221dc7cFe2eceD9a30A6Cb0483b;
    uint256 constant RATE = 5;

    constructor() ERC721("Pixegami Nova", "PXEN") {}
    ...
    {
        uint256 royaltyAmount = (_tokenId * 0) + (RATE * _salePrice) / 100;
